...
document.getElementById('pencilThickness').addEventListener('change', setPencilThickness);
document.getElementById('eraserType').addEventListener('change', setEraserType);
document.getElementById('eraserThickness').addEventListener('change', setEraserThickness);
...
function startErasing(e) {
  ...
  if (eraserType === 'circle') {
    ...
    context.clearRect(x - eraserThickness / 2, y - eraserThickness / 2, eraserThickness, eraserThickness);
  } else if (eraserType === 'diamond') {
    context.save();
    context.translate(x, y);
    context.rotate(Math.PI / 4);
    context.clearRect(-eraserThickness / 2, -eraserThickness / 2, eraserThickness, eraserThickness);
    context.restore();
  }
}
